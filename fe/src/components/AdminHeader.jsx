...
function AdminHeader() {
  ...
  const canViewServicesAndProducts = ["ROLE_ADMIN", "ROLE_DIRECTOR"].includes(
    userRole,
  );
  const canViewUsersAndStores = ["ROLE_ADMIN", "ROLE_DIRECTOR"].includes(
    userRole,
  );
      ...
      <div className="container">
        <div className="navbar">
          ...
          <nav className="nav-links">
            ...
            {canCreateOrders && (
              <NavLink to="/admin/create-order">Tạo đơn hàng</NavLink>
            )}
            {canViewInventory && (
              <NavLink to="/admin/inventory">Quản lý kho</NavLink>
            )}
            ...
            {canViewAppointments && (
              <NavLink to="/admin/appointments">Quản lý Đặt lịch</NavLink>
            )}
